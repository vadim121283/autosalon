module.exports = {
  ...
  db: {
    username: process.env.DATABASE_USERNAME_DEV || "autosalon",
    password: process.env.DATABASE_PASSWORD_DEV || "autosalon",
    database: process.env.DATABASE_NAME_DEV || "autosalon",
    sql: {
      host: "127.0.0.1",
      dialect: "postgres",
      pool: {
